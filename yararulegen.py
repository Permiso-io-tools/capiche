from yarastringgen import generate_yara_string
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("-MetaAuthor", required=True, help="Author for the YARA rule")
    parser.add_argument("-MetaDescription", required=True, help="Description for the YARA rule")
    parser.add_argument("-Strings", nargs='+', required=True, help="List of YARA strings")
    parser.add_argument("-Condition", required=True, help="Condition for the YARA rule")
    parser.add_argument("-MetaDynamicDictionary", nargs='+', help="Dynamic metadata for the YARA rule")
